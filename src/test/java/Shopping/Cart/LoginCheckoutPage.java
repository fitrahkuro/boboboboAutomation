...
public class LoginCheckoutPage {
    ...
    public LoginCheckoutPage doLogin(String email, String password) {
        userEmail.click();
    ...
    public LoginCheckoutPage clickRegister() {
        register.click();
        return this;
    }

    // This method will create a new account
    public LoginCheckoutPage doRegister(int index, String fname, String lname, String email, String pass1, String pass2) {
        // select title
    ...
    public LoginCheckoutPage clickForgotPass() {
        forgotPassElm.click();
        return this;
    }
